...
SpringBag::SpringBag(double distance, double perDay, const std::string& file1, const std::string& file2, const std::string& file3)
: Bag(distance, perDay), in_file1(file1), in_file2(file2), in_file3(file3)
{
    setDays(days);
}

SpringBag::~SpringBag() = default;

void SpringBag::setDays(int _days)
{
    _days = calculateDays();
    days = _days;
}

int SpringBag::getDays() const
{
    return days;
}

void SpringBag::addClothing()
{
